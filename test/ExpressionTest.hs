...
testParseExpressionNumericExpGreater = assertEqual "parseExpressionNumericExpGreater" (parse parseExpression "" "1 > 2") (Right (BooleanExpression (BooleanOp (Literal (IntegerLiteral 1)) GreaterThan (Literal (IntegerLiteral 2)))))

testParseExpressionNumericExpGreaterEq :: Assertion
testParseExpressionNumericExpGreaterEq = assertEqual "parseExpressionNumericExpGreaterEq" (parse parseExpression "" "1 >= 2") (Right (BooleanExpression (BooleanOp (Literal (IntegerLiteral 1)) GreatEqualThan (Literal (IntegerLiteral 2)))))

testParseExpressionNumericExpLess :: Assertion
testParseExpressionNumericExpLess = assertEqual "parseExpressionNumericExpLess" (parse parseExpression "" "1 < 2") (Right (BooleanExpression (BooleanOp (Literal (IntegerLiteral 1)) LessThan (Literal (IntegerLiteral 2)))))

testParseExpressionNumericExpLessEq :: Assertion
testParseExpressionNumericExpLessEq = assertEqual "parseExpressionNumericExpLessEq" (parse parseExpression "" "1 <= 2") (Right (BooleanExpression (BooleanOp (Literal (IntegerLiteral 1)) LessEqualThan (Literal (IntegerLiteral 2)))))

testParseExpressionNumericExpDifferent :: Assertion
testParseExpressionNumericExpDifferent = assertEqual "parseExpressionNumericExpDifferent" (parse parseExpression "" "1 != 2") (Right (BooleanExpression (BooleanOp (Literal (IntegerLiteral 1)) NotEqual (Literal (IntegerLiteral 2)))))

testParseExpressionNumericExpEqual :: Assertion
testParseExpressionNumericExpEqual = assertEqual "parseExpressionNumericExpEqual" (parse parseExpression "" "1 == 2") (Right (BooleanExpression (BooleanOp (Literal (IntegerLiteral 1)) Equal (Literal (IntegerLiteral 2)))))
