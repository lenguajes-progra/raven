...
testVariableDefinitionParserAssignTypeError = assertEqual "parseVariableDefinitionAssignmentError" (parse variableDefinitionParser "" "int a = true;") (Right (VariableErrorDefinition (ErrorType AssignType)))

testArrayDefinitionParserWithAssignment :: Assertion
testArrayDefinitionParserWithAssignment = assertEqual "parseArrayDefinitionWithAssignment" (parse arrayDefinitionParser "" "[boolean] arr = [true, false];") (Right (ArrayDefinitionComplete (ArrayType BooleanType) (Ident "arr") (Literals [BooleanLiteral True,BooleanLiteral False])))
...
testArrayDefinitionParserAssignTypeError = assertEqual "parseArrayDefinitionAssignmentError" (parse arrayDefinitionParser "" "[int] arr = [1,2,true];") (Right (ArrayErrorDefinition (ErrorType AssignType)))
